...
2. The information in ``gbt_2260-2007.csv`` (provided by Github user @qiaolun) and ``gbt_2260-2007_sup.csv`` (supplement, by @khaeru) transcribed from the published GB/T 2260-2007 standard.
